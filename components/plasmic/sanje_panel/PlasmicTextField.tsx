...
import Label from "../../Label"; // plasmic-import: HrBj-zPT9hmk/component
import TextInput from "../../TextInput"; // plasmic-import: cUKxF1SsNd5_/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: 6lTsbja7hqTc/component
import Description from "../../Description"; // plasmic-import: 1eYhtagHUPjz/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: bYlyTDdEG1X1/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: pi4ajG1MDyq3/icon
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__u88AU, {
          [sty.freeBoxiconEnd__u88AU0ToZd]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__u88AUvClBd]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__u88AU5Nyai]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__noihi, {
            [sty.freeBoxiconStart__noihivClBd]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__noihi5Nyai]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__lcmPh)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__iwxeb, {
            [sty.freeBoxiconEnd__iwxeb0ToZd]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__iwxebvClBd]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__he8Ip)}
                role={"img"}
              />
            ),
